...
describe('App', () => {
  ...
  describe('mapStateToProps', () => {
    it('returns the correct object when passing a state with isUserLoggedIn set to true', () => {
      const state = {
        ui: Map({ isUserLoggedIn: true, isNotificationDrawerVisible: false })
      };
      const expectedProps = { isLoggedIn: true, displayDrawer: false };
      expect(mapStateToProps(state)).toEqual(expectedProps);
    });

    it('returns the correct object when passing a state with isUserLoggedIn set to false', () => {
      const state = {
        ui: Map({ isUserLoggedIn: false, isNotificationDrawerVisible: true })
      };
